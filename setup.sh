...
mv coref_ops.py ./backup/coref_ops.py.bak
mv demo.py ./backup/demo.py.bak
mv metrics.py ./backup/metrics.py.bak
mv predict.py ./backup/predict.py.bak
mv util.py ./backup/util.py.bak

patch --input=./patch/coref_model.py.patch --output=./coref_model.py ./backup/coref_model.py.bak
patch --input=./patch/coref_ops.py.patch --output=./coref_ops.py ./backup/coref_ops.py.bak
patch --input=./patch/demo.py.patch --output=./demo.py ./backup/demo.py.bak
patch --input=./patch/metrics.py.patch --output=./metrics.py ./backup/metrics.py.bak
patch --input=./patch/predict.py.patch --output=./predict.py ./backup/predict.py.bak
patch --input=./patch/util.py.patch --output=./util.py ./backup/util.py.bak
